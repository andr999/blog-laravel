            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <img src="{{$post->getImage()}}" alt="" class="img-responsive" width="200" name="image">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::select(
                               'tags[]',
                               $tags,
                               $post->tags->pluck('id')->all(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'data-placeholder' => 'Выберите теги']
                              )}}
                        </div>
                        <!-- Date -->
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="exampleInputEmail1" cols="30" rows="10" class="form-control"  name="description">{{$post->description}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
