            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->author->getImage()}}" class="pull-left img-responsive" width="100" height="100" alt="">
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img class="img-circle img-responsive" src="{{$comment->author->getImage()}}" alt="">
                        </div>
